...
export function listOpeningSubjects(params = {}) {
  return request.get('/opening-subject/list', { params })
}

export function createOpeningSubject(data) {
  return request.post('/opening-subject', data)
}

export function updateOpeningSubject(data) {
  return request.put('/opening-subject', data)
}

export function deleteOpeningSubject(fid) {
  return request.delete(`/opening-subject/${fid}`)
}

export function listOpeningCashflows(params = {}) {
  return request.get('/opening-cashflow/list', { params })
}

export function createOpeningCashflow(data) {
  return request.post('/opening-cashflow', data)
}

export function updateOpeningCashflow(data) {
  return request.put('/opening-cashflow', data)
}

export function deleteOpeningCashflow(fid) {
  return request.delete(`/opening-cashflow/${fid}`)
}

export function listOpeningCounterparties(params = {}) {
  return request.get('/opening-counterparty/list', { params })
}

export function createOpeningCounterparty(data) {
  return request.post('/opening-counterparty', data)
}

export function updateOpeningCounterparty(data) {
  return request.put('/opening-counterparty', data)
}

export function deleteOpeningCounterparty(fid) {
  return request.delete(`/opening-counterparty/${fid}`)
}
