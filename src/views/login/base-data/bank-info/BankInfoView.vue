<template>
  <div class="bank-info-page">
    ...
    <v-dialog v-model="actionDialog.visible" max-width="420">
      <v-card>
        <v-card-title class="text-h6">行名行号操作</v-card-title>
        <v-card-text>
...
import bankInfoApi from '@/api/bankInfo'
import { useReviewActions } from '@/composables/useReview'

const { list, loading, fetchList, createItem, editItem, deleteItem } = useSimpleData(bankInfoApi)
